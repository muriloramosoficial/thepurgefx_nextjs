...
import LastedUsersRegistered from './last_users_register';
...
const DashboardContent = () => {
    return (
        <div>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-2 pt-3'>
                <div className="flex flex-row p-10 bg-slate-600 rounded-xl" id="tableLeft">
                    <LastedUsersRegistered />
                </div>
                {/* <div className="flex flex-row p-10 bg-slate-600 rounded-xl" id="tableRight">
                    <LastedUsersRegistered />
                </div> */}
            </div>
        </div>
