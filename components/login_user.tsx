  ...
  return (
    <div className='items-center justify-center p-10'>
      ...
      <div className="relative pl-1 pr-1 pb-3">
        <input type="text" id="password" className="block text-center uppercase text-2xl mb-2 border-t-2 border-b-2 border-slate-700 p-2.5 w-full text-slate-700 bg-transparent" placeholder="SIGN IN TO YOUR ACCOUNT" disabled={true} />
      </div>
